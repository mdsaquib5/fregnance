                  ...
                  <div className='flex gap-4'>
                    ...
                    <div className='flex-1 min-w-0'>
                      ...
                      <div className='flex items-center gap-2'>
                        <button className='flex items-center gap-1 px-3 py-1.5 text-xs bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors'>
                          <Eye className='w-4 h-4' />
                          View
                        </button>
                        <button className='flex items-center gap-1 px-3 py-1.5 text-xs bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors'>
