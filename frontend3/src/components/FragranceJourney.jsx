                ...
                <div>
                    <div className='grid lg:grid-cols-2 gap-0 items-center'>
                        <div className='px-6 sm:px-12 lg:px-16 py-12 lg:py-24'>
                            ...
                            <Link to='/collection' className='bg-pink-500 hover:bg-pink-600 text-white font-body font-semibold px-8 py-3 rounded-full transition-all duration-300 shadow-md hover:shadow-lg uppercase text-sm tracking-wide'>
                                Discover Now
                            </Link>
                        </div>
